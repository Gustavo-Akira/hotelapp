...
class HotelProvider : ContentProvider() {
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        ...
        val rowsDelected = when(uriType){
            ...
            TYPE_HOTEL_ITEM ->{
                ...
                sqlDB.delete(TABLE_HOTEL, "$COLUMN_ID= ?", arrayOf(id))
            }
    ...
    override fun getType(uri: Uri): String? {
        ...
        return when(uriType){
            TYPE_HOTEL_DIR ->
                return "${ContentResolver.CURSOR_DIR_BASE_TYPE}//br.gustavoakira.hotel"
            TYPE_HOTEL_ITEM ->
                return "${ContentResolver.CURSOR_ITEM_BASE_TYPE}//br.gustavoakira.hotel"
            else -> null
        }
    }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        ...
        when(uriType){
            TYPE_HOTEL_DIR ->
                ...
                throw IllegalArgumentException("URI não suportado: $uri")
        }
        context?.contentResolver?.notifyChange(uri,null)
    ...
    companion object{
        private const val AUTHORITY = "br.gustavoakira.hotel"
